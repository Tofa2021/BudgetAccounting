...
public class RequestProcessor { // TODO if request have token user cannot use SIGN_IN and SIGN_UP
    ...
    private final Set<AuthorizedRequestHandler> authorizedRequestHandlers;

    private final Set<UnauthorizedRequestHandler> unauthorizedRequestHandlers;

    public RequestProcessor(TokenProvider tokenProvider, AccountMemberRequestHandler accountMemberRequestHandler, AccountRequestHandler accountRequestHandler, AuthRequestHandler authRequestHandler, CategoryRequestHandler categoryRequestHandler, HouseholdMemberRequestHandler householdMemberRequestHandler, HouseholdRequestHandler householdRequestHandler, OperationRequestHandler operationRequestHandler, UserRequestHandler userRequestHandler) {
        this.tokenProvider = tokenProvider;

        this.authorizedRequestHandlers = Set.of(
        ...
        this.unauthorizedRequestHandlers = Set.of(
                authRequestHandler
        );
    }
