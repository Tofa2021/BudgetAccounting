...
import org.example.client.viewModel.ExpensePieChartViewModel;

public class ExpensePieChartView extends BaseView<ExpensePieChartViewModel> {
    @FXML
    ...
    public void onViewModelSet() {
        pieChart.setData(getViewModel().getExpensePieData());
        placeholder.setVisible(false);

        getViewModel().getExpensePieData().addListener((ListChangeListener<? super PieChart.Data>) c -> {
